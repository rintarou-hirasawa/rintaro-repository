        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-20">
            ...
            <div className="fade-in">
              ...
              {/* 動画1 - 海外進出支援 */}
              <div className="aspect-video w-full rounded-lg overflow-hidden shadow-lg mb-8 fade-in">
                <video
                  ...
                  preload="metadata"
                >
                  <source src="/video/794897340.998299.mp4" type="video/mp4" />
            ...
            <div className="fade-in">
              ...
              <div className="aspect-video w-full rounded-lg overflow-hidden shadow-lg mb-8 fade-in">
                <video
                  ...
                  preload="metadata"
                >
                  <source src="/video/794897341.027022.mp4" type="video/mp4" />
                  お使いのブラウザは動画に対応していません。
                </video>
              </div>
            </div>
            ...
            <div className="fade-in">
              <div className="aspect-video w-full rounded-lg overflow-hidden shadow-lg">
                <video
                  ...
                  preload="metadata"
                >
                  <source src="/video/794897341.054587.mp4" type="video/mp4" />
                  お使いのブラウザは動画に対応していません。
                </video>
              </div>
            </div>
